...
[![Version](https://img.shields.io/badge/version-1.1.0-blue.svg)](https://github.com/xiaoailazy/coexistree/releases)
...
CoExistree 是一个面向研发团队的知识管理与智能问答平台。它将文档从静态资料转变为系统的"成长记录"，实现知识随系统共同演进，并基于细粒度权限管控确保敏感信息安全。

![CoExistree 截图](docs/public/images/screenshot.png)
