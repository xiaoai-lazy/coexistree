...
public class SecurityConfig {
    ...
    /**
     * Use inheritable thread-local strategy for SecurityContext propagation.
     * This ensures the SecurityContext set by JwtAuthenticationFilter on the
     * main request thread is visible to async dispatch threads (SSE, etc.).
     */
    @PostConstruct
    public void init() {
