...
@Entity
@Table(name = "doc_llm_call_logs")
public class DocLlmCallLogEntity {
    ...
    public Long getProcessLogId() { return processLogId; }
    public void setProcessLogId(Long processLogId) { this.processLogId = processLogId; }
